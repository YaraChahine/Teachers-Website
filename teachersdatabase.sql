...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 28, 2021 at 12:46 AM
...
(13, 'alii', 'sgasas', 'ali.knayber@hotmail.com', '96bb5ece92649c554f0503e0d4e3463dbf195a13cadee3b760a3a09da1abd18a', 32, 'male', '1121111', 'wDSA', 'highschool-degree', 'grss sg', '3434', 3, 'Math', 'primary', 'Math', 'primary', 'houg', 'college', 'ok', 'college', 'hi.pdf', 'hi.png', 'ddf'),
...
--
ALTER TABLE `pending_students`
  MODIFY `temp_student_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pending_tutors`
--
ALTER TABLE `pending_tutors`
  MODIFY `temp_user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
