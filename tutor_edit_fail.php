...
.success-page h3 {
  ...
  .btn1 {
    ...
    background-color: #04c2f9;
    border-style: none;
    color:white
  }
</style>
  <div class="success-page" >
    <h3 class="text-center">You have already sent an Edit Request. Your last request has to be epproved/rejected before you can submit a new one. For more info, please contact us.</h3>
    <a href="profile_tutor.php"><button class="btn1">OK</button></a>
  </div>
