...
<body  onload="remove-form.reset();">
        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li> <a  style="cursor: pointer ;" class="nav-link scrollto rmov" data-bs-toggle="modal" data-bs-target="#remove-modal" >
    ...
    <!-- Free consultation-->
    <div class="modal modal-large fade" id="remove-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-5">
                    <h2 class="text-center">Remove Member form</h1>
                        <p style="color:red;margin-left:30px;">Caution: Removing a member will delete them permanently from the database.</p>
